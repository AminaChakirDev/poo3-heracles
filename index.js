...
const heracles = new Hero('👨 Heracles', 20, 6, './images/heracles.svg', 4, 7);
...
const bird1 = new Monster('Bird', 25, 12, './images/bird.svg', 5, 7);
const bird2 = new Monster('Bird', 25, 12, './images/bird.svg', 6, 3);
const bird3 = new Monster('Bird', 25, 12, './images/bird.svg', 2, 2);
...
const newArena = new Arena([bird1, bird2, bird3], heracles);
const ArenaHTML = new ArenaTemplate('arena');
ArenaHTML.createArena(newArena);
